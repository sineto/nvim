local cmd        = vim.cmd
local map        = om.map
local noremap    = om.noremap
local nnoremap   = om.nnoremap
local inoremap   = om.inoremap
local vnoremap   = om.vnoremap
local xnoremap   = om.xnoremap
local map_leader = om.map_leader_keys
